      ...
      <div className='games-container'>
        ...
        <ul className='gameListInClass'>
          ...
          <li className='gameListInClass-item'>
            <Link to='/games/classNumber/3/category/reading'> Читання </Link>
          </li>
          <li className='gameListInClass-item'><Link to={'/games/classNumber/3/category/math'}>Математика</Link></li>
        </ul>
      </div>
    );
